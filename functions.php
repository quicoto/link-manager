 ...
 */
function link_manager_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'link_manager_content_width', 640 );
}
add_action( 'after_setup_theme', 'link_manager_content_width', 0 );
 ...
 */
function link_manager_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'link-manager' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'link-manager' ),
...
add_action( 'widgets_init', 'link_manager_widgets_init' );
